...
void rtcSetInterruptCb(void (*secIntCb)(uint32_t cnt), void (*alrmIntCb)(uint32_t cnt));
uint32_t rtcGetCounter();

extern void (*rtcSecIntCb)(uint32_t cnt);
extern void (*rtcAlrmIntCb)(uint32_t cnt);
